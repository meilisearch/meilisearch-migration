...
**MeiliSearch Version Update Script** is a script that migrates your MeiliSearch from a version to another more recent version, it also works with release candidates.
